...
async def plan_node(state: ConductorState, runnable_config: RunnableConfig) -> dict[str, object]:
    ...
    steps = to_steps(extract_json_array(raw), start_index=0, max_new=config.MAX_STEPS)
